...
public final class Constants {
  ...
  public static class Drive {
    ...
    private static final double MAX_ROTATIONS_PER_SECOND = 1.5; // number of rotations in a second
    public static final double MAX_ROTATION_RATE_RPS = MAX_ROTATIONS_PER_SECOND * 2.0 * Math.PI; // radians per second

    public static final double MIN_TRANSLATE_MPS = 0.01; // meters per second
    public static final double MIN_ROTATE_RPS = Math.toRadians(5); // radians per second

    public static final double AMP_SLOWDOWN_SCALAR = 0.5;
    public static final double AMP_ANGLE_ADJUST_DEG = 10.0;
