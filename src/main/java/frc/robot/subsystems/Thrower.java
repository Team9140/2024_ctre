...
public class Thrower extends SubsystemBase {
    ...
    private Thrower() {
        ...
        CurrentLimitsConfigs launcherCurrentLimits = new CurrentLimitsConfigs()
                .withStatorCurrentLimit(Constants.Thrower.Launcher.MAX_CURRENT).withStatorCurrentLimitEnable(true);
    ...
    /**
     * Ensures there is only one Thrower instance to ensure that all calls will
    ...
    public Command setIntake() {
        return this.setLauncherVoltage(Constants.Thrower.Launcher.INTAKE_VOLTAGE)
                .andThen(this.setFeederVoltage(Constants.Thrower.Feeder.INTAKE_VOLTAGE));
    }
    ...
    public Command prepareSpeaker() {
        return this.setLauncherVoltage(Constants.Thrower.Launcher.SPEAKER_VOLTAGE)
                .andThen(this.setFeederVoltage(Constants.Thrower.Feeder.PREPARE_VOLTAGE));
    }
    ...
    public Command prepareAmp() {
        return this.setLauncherVoltage(Constants.Thrower.Launcher.TOP_AMP_VOLTAGE,
                Constants.Thrower.Launcher.BOTTOM_AMP_VOLTAGE);
    }
    ...
    public Command launch() {
        // return this.setFeederVoltage(this.topLauncherController.Output <= 0.0 ?
        // Constants.Thrower.Feeder.PREPARE_VOLTAGE :
        // Constants.Thrower.Feeder.LAUNCH_VOLTAGE);
