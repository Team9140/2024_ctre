...
public class RunAuto extends Command {
    ...
    public RunAuto(String name, CommandSwerveDrivetrain drivetrain, int numPaths, boolean mirror, Field2d field) {
    ...
    public RunAuto(String name, CommandSwerveDrivetrain drivetrain, int numPaths, boolean mirror) {
